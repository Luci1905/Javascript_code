...
const prompt = promptSync();
 ...
 export function verificarMaiorIdade(){
    let idade;
   console.log("Exercicio 5 - Faça um programa que receba nome e idade do ususário, enquanto a resposta do usuário for menor que 18 anos continue a solicitar a idade e mostre uma mensagem quando a idade do usuário for maior que 18");
let pessoa = {
    nome: "",
    idade: 0
}
